...
def historial_citas_empresa(request):
    ...
    for cita in historial:
        fecha_hora_cita = datetime.combine(cita.fecha, cita.hora)
        # Si usas timezone, puedes convertirlo a aware así:
        ...
        # Total servicios seguro
        cita.total_servicios = cita.servicio.precio if cita.servicio and cita.servicio.precio else 0

    # Resumen mensual de ingresos por servicios completados
    resumen_qs = (
    ...
    # Función para formatear número a formato RD (mil con puntos, decimales con coma)
